...
<section class="home">
    <div class="flex-parent">
        ...
        <div class="boxone">
            ...
            <p style="text-align: center;" class='myButton' ><a  href="doctor_login.php">I'm Doctor</a></p>
        </div>
        <!-- i m Patient -->
        <div class="boxone">
            <img src="assets/img/pat.png" alt="Patient" width="400" height="400">
            <p style="text-align: center;" class='myButton' ><a  href="patient_login.php">I'm Patient</a></p>
        </div>
    </div>
</section>
